...
-   Basic metrics
    ...
    |------|----|----------|----------|----------|
    |Advance Credit|Count|AdvanceCredit|userId and instanceId|Maximum, Minimum, and Average|
    ...
    |\(ECS\) SystemDiskReadIOPS|Count/Second|DiskReadIOPS|userId and instanceId|Maximum, Minimum, and Average|
    |\(ECS\) Disk Write BPS|Byte/s|DiskWriteBPS|userId and instanceId|Maximum, Minimum, and Average|
    |\(ECS\) Disk Write IOPS|Count/Second|DiskWriteIOPS|userId and instanceId|Maximum, Minimum, and Average|
